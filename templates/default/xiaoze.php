...
<body class = "mdui-drawer-body-left mdui-appbar-with-toolbar mdui-theme-primary-indigo mdui-theme-accent-pink mdui-loaded">
	...
	<header class = "mdui-appbar mdui-appbar-fixed">
		...
		<span class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-drawer="{target: '#drawer', swipe: true}"><i class="mdui-icon material-icons">menu</i></span>
		  <a href="" class = "mdui-typo-headline" title = "<?php echo getconfig("description");?>"><span class="mdui-typo-title"><?php echo getconfig("logo");?></span></a>
	...
	c0,0.4,0.3,0.9,1.1,0.8c6.5-2.2,11.1-8.3,11.1-15.5C34.3,8.7,27,1.4,18,1.4z"></path>
	  ...
	  <?php }elseif (getconfig('GoAdmin')  == 'on'  ){ ?>
		<a class = "mdui-hidden-xs" href="./index.php?c=<?php if($login =='login'){echo $login;}else{echo $Elogin;}?>&u=<?php echo $u?>" title = "登录OneNav" target="_blank" class="mdui-btn mdui-btn-icon"><i class="mdui-icon material-icons">account_circle</i></a>
	  <?php } ?>
    </a>
		</div>
	</header>
...
<!-- 返回顶部按钮 -->
	...
	<!-- 魔改版由落幕修改,开源地址:https://gitee.com/tznb/OneNav -->
	<footer>
		© 2022 Powered by <a target = "_blank" href="https://github.com/helloxz/onenav" title = "简约导航/书签管理器" rel = "nofollow">OneNav</a>.The author is <a href="https://www.xiaoz.me/" target="_blank" title = "小z博客">xiaoz.me</a> . <a href="https://gitee.com/tznb/OneNav" target="_blank" title = "新增N多功能,详情到码云看哦!">魔改版</a>
