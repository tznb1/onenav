...
<div class="layui-layout layui-layout-admin">
  <div class="layui-header">
    <div class="layui-logo " style ="box-shadow: 0 0 0 rgba(0,0,0,0);"><a href=""  title = "爱导航" style="color:#009688;"><h3><?php echo $site['logo'];?></h3></a></div>
    ...
    <ul class="layui-nav layui-layout-right">
      <li class="layui-nav-item layui-hide layui-show-md-inline-block">
        ...
        <dl class="layui-nav-child">
            <?php  
            if (!$is_login && $site['GoAdmin']){
                echo '<dd><a href="./index.php?c='.($login =='login'? $login:$Elogin).'&u='.$u.'">登录后台</a></dd>';
            } ?>
            <?php  echo $is_login ? '<dd><a href="./index.php?c=admin&u='.$u.'">后台管理</a></dd><dd><a href="">退出登录</a></dd>':'';  ?>
            <!--<dd><a href="">主题设置</a></dd>-->
        </dl>
      </li>
    </ul>
  ...
  <div class="layui-bg-gray" style="padding: 20px;">
    <!--<div class="layui-collapse" >-->
        <fieldset class="layui-elem-field layui-field-title" >
            <legend>注意:该主题开发中,尚未适配移动终端!如有建议请在群里反馈!</legend>
        </fieldset>
<?php 
foreach ($category_parent as $category) {
    $fid = $category['id'];
    ...
    <?php } ?>
        ...
        <?php foreach (get_category_sub( $category['id'] ) AS $category_sub){
            ...
            ?>
            <div class="cat-title2" name ="锚点" id = "category-<?php echo $category_sub['id']; ?>"></div>
            <div class="layui-collapse">
                <div class="layui-colla-item">
