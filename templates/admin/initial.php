...
<form class="layui-form layui-form-pane" action="">
  ...
  <div class="layui-form-item">
    ...
    <div class="layui-input-block">
      <input type="text" name="Email" required value="<?php echo $Email; ?>" lay-verify="required" lay-verify="email" placeholder="请输入邮箱" <?php if($xiaoz) {echo 'readonly="readonly"';} ?> autocomplete="off" class="layui-input">
    </div>
  </div>
<?php if( $xiaoz ){ 
