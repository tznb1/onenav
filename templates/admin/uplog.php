<li class="layui-timeline-item">
    ...
    <div class="layui-timeline-content layui-text">
      <h4 class="layui-timeline-title">2023年12月22日</h4>
      <ul>
        <li>终结版: 移除依赖服务器的相关功能 ( 因为服务器已关闭 )</li>
        <li>下载新版本: <a href="https://gitee.com/tznb/TwoNav" target="_blank">https://gitee.com/tznb/TwoNav</a></li>
      </ul>
    </div>
</li>
<li class="layui-timeline-item">
